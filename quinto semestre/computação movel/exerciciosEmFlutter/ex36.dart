...
class SomaNumerosState extends State<SomaNumeros> {
    ...
    String _stringComNumeros = "Numeros impares e divisíveis por 15 dentro da seguinte faixa: 999 até 2000. ";
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text(
              '36) Exiba todos os números impares e divisíveis por 15 dentro da seguinte faixa: 999 até 2000.',
