...
class SomaNumerosState extends State<SomaNumeros> {
    ...
    String _stringComNumeros = "multiplicação parcial de todos os números de 255 até 555: ";
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text(
              '38) Imprima a multiplicação parcial de todos os números de 255 até 555.',
