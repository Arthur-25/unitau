  ...
  void _efetuarProcessamento() {
    ...
    if (numero1 == 3){
      ...
      if (numero3 != 0){
        ...
        _mensagemOperacao = "Não é possivel dividir por zero";
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
              ...
              const Text(
              '26) Desenvolver um programa que solicite 3 valores para o usuário. O primeiro valor vai indicar qual operação matemática será efetuada (0: Soma; 1: Subtração; 2: Multiplicação: 3: Divisão). Se for escolhida a divisão e o divisor for zero, o programa deverá retornar a mensagem "Não é possível dividir por zero".Se for escolhida uma operação inválida (fora da faixa entre 0 e 3), deverá retornar a mensagem "Operação inválida".',
