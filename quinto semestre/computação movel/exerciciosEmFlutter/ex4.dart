...
class SomaNumerosState extends State<SomaNumeros> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text("Exercício 4")),
      ),
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text(
              '4) Desenvolver um programa que efetue o cálculo da área do triângulo.',
            ...
            TextField(
              ...
              Text(
                ...
                'A area do triangulo é: $_areaTriangulo',
